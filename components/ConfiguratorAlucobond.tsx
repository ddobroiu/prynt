...
const ProductTabs = ({ productSlug }: { productSlug: string }) => {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200">
            ...
            <div className="p-6">
                {activeTab === 'descriere' && <div className="prose max-w-none text-sm"><h3>Panouri Alucobond (Bond)</h3><p>Soluția premium pentru signalistică rigidă. Panourile compozite din aluminiu oferă o planeitate perfectă, rigiditate și un aspect modern. Ideale pentru placări de fațade, panouri publicitare de mari dimensiuni și decorări interioare.</p></div>}
            ...
            <div className="mt-8 bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-base font-bold text-gray-900 mb-1">Material Premium</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-base font-bold text-gray-900 mb-1">Rezistență Superioară</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-base font-bold text-gray-900 mb-1">Print Direct UV</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-base font-bold text-gray-900 mb-1">Dimensiuni Mari</h3>
