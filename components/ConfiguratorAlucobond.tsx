            ...
            <div className="card p-4">
              ...
              <div className="relative">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  ...
                  <button onClick={() => setDesignOption("text_only")} className={`p-3 rounded-lg border ${designOption === "text_only" ? "border-indigo-500 bg-indigo-900/10" : "border-white/10 hover:bg-white/5"}`}>Text (gratis)</button>
              ...
              {designOption === "text_only" && (
                <div className="panel p-3 mt-3 border-t border-white/5">
                  <textarea value={textDesign} onChange={(e) => setTextDesign(e.target.value)} rows={3} placeholder="Ex: LOGO • TEXT PROMO" className="input resize-y min-h-[80px]" />
                </div>
              )}
