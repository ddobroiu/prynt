    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200">
            ...
            <div className="p-6 lg:p-8">
                {activeTab === 'descriere' && (
                  <>
                    <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">Plăci PVC Expandat (Forex)</h2>
                    <p className="text-gray-700 mb-8 leading-relaxed text-base lg:text-lg">
                      Material versatil, ușor și economic pentru o gamă largă de aplicații publicitare: panouri, display-uri, litere volumetrice, decorațiuni. Suprafață albă, mată, perfectă pentru imprimare UV.
                    </p>
  ...
  return (
    <main className="bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 py-10 lg:py-16">
        ...
        <div className="mt-8 lg:mt-12"><ProductTabs productSlug={productSlug || 'pvc-forex'} /></div>
      </div>
