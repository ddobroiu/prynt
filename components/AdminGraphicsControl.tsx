            ...
            <div key={idx} className="bg-white/5 p-4 rounded-xl border border-white/5 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                {item.artworkUrl ? (
                  ...
                  <div className="flex items-center gap-2 bg-amber-500/10 border border-amber-500/20 p-2 rounded-lg text-amber-600 w-full sm:w-auto justify-center">
                    <FileText size={16} />
                    <span className="text-xs font-medium">Grafică text introdusă</span>
                  </div>
                ) : (
